...
let MesnWear = () => {
  ...
  let clickAddToCart = (product) => {
    ...
    dispatch(orderAction.addToCart(productWithQty, navigate));
  };
              ...
              <div className="container grid grid-cols-2 gap-x-3 gap-y-4 md:grid-cols-3 lg:grid-cols-4">
                {products.length > 0 &&
                  products.map((product) => {
                    return (
                      <div
                        className=" relative border-2 border-gray-400 shadow-lg rounded"
                        key={product._id}
                      >
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div>
                            <span
                              ...
                              className="text-gray-700 hover:cursor-pointer hover:text-indigo-500 "
                            >
                              <svg
